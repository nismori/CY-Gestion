  ...
  return (
    <div>
      <div className="fixed top-0 left-0 w-screen h-screen bg-neutral-900 -z-10">
        <div className="py-5 absolute z-10 left-1/2 -translate-x-1/2 flex items-center gap-2 mx-auto font-georgia tracking-tight text-center text-transparent  mt-[20vh] md:text-xl md:leading-tight bg-clip-text bg-gradient-to-b from-neutral-800 via-white to-purple-900">
